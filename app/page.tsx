...
function DiscordBTN({}) {
  return (
    <>
      <div className="bg-middle-gray h-12 w-12 clicked:rounded-[0.85rem] flex content-center justify-center text-white  rounded-[1.5rem] hover:bg-discordBlue hover:rounded-[0.85rem] transtion duration-[170ms] ease-in">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="27"
          height="26"
